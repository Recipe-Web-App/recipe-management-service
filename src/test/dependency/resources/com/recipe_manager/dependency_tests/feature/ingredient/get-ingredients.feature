Feature: Get Ingredients Endpoint
  ...
  Scenario: Get ingredients for a recipe
    Given url baseUrl + '/api/v1/recipe-management/recipe-management/recipes/123/ingredients'
    When method GET
    Then status 200
  ...
  Scenario: Get ingredients for non-existent recipe
    Given url baseUrl + '/api/v1/recipe-management/recipe-management/recipes/999999/ingredients'
    When method GET
    Then status 200
