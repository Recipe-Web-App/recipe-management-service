...
class RecipeIngredientMediaDtoTest {
  ...
  void builderSetsFieldsAndDefaults() {
    RecipeIngredientMediaDto dto = RecipeIngredientMediaDto.builder().mediaId(1L).recipeId(2L).ingredientId(3L).build();
    assertThat(dto.getMediaId()).isEqualTo(1L);
    assertThat(dto.getRecipeId()).isEqualTo(2L);
    assertThat(dto.getIngredientId()).isEqualTo(3L);
  }
  ...
  void equalsHashCodeToString() {
    RecipeIngredientMediaDto dto1 = RecipeIngredientMediaDto.builder().mediaId(1L).ingredientId(2L).build();
    RecipeIngredientMediaDto dto2 = RecipeIngredientMediaDto.builder().mediaId(1L).ingredientId(2L).build();
